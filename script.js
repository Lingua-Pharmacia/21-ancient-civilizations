...
// PERSISTENCE (Specific to Civilizations)
let lifetimeScore = parseInt(localStorage.getItem('civilizationsScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedCivilizationsLessons')) || [];
...
// STATIONS 
const stations = [
    {file:"01_Akkadians.mp3", title:"Akkadians"},
    {file:"02_AncientEgyptians.mp3", title:"Ancient Egyptians"},
    {file:"03_AncientGreeks.mp3", title:"Ancient Greeks"},
    {file:"04_Assyrians.mp3", title:"Assyrians"},
    {file:"05_Aztecs.mp3", title:"Aztecs"},
    {file:"06_Babylonians.mp3", title:"Babylonians"},
    {file:"07_Carthaginians.mp3", title:"Carthaginians"},
    {file:"08_Celts.mp3", title:"Celts"},
    {file:"09_Etruscans.mp3", title:"Etruscans"},
    {file:"10_Hittites.mp3", title:"Hittites"},
    {file:"11_Incas.mp3", title:"Incas"},
    {file:"12_IndusValley.mp3", title:"Indus Valley Civilization"},
    {file:"13_Mayans.mp3", title:"Mayans"},
    {file:"14_Minoans.mp3", title:"Minoans"},
    {file:"15_Mycenaeans.mp3", title:"Mycenaeans"},
    {file:"16_Olmecs.mp3", title:"Olmecs"},
    {file:"17_Persians.mp3", title:"Persians"},
    {file:"18_Phoenicians.mp3", title:"Phoenicians"},
    {file:"19_Romans.mp3", title:"Romans"},
    {file:"20_Sumerians.mp3", title:"Sumerians"},
    {file:"21_ZhouDynasty.mp3", title:"Zhou Dynasty"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('civilizationsScore', lifetimeScore);
    const fn = audio.src.split('/').pop();
    if(!completedLessons.includes(fn)) {
        completedLessons.push(fn); localStorage.setItem('completedCivilizationsLessons', JSON.stringify(completedLessons));
    }
